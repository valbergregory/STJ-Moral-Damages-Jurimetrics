...
md <- c("# 06 — Censo dos metadados completos", "",
        ...
        "Leitura: em 2021 e 2026 o STJ publica o caminho completo dos assuntos; em 2022–2023 só códigos-folha (≈1,7 por doc); em **2024–2025 um único código por documento** (provavelmente o assunto principal). Logo, contagens por código pai (7779, 10433) caem artificialmente em 2024–2025, enquanto contagens por família (pai + descendentes) permanecem comparáveis.", "",
